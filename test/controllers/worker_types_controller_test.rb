...
class WorkerTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker_type" do
    assert_difference('WorkerType.count') do
      post worker_types_url, params: { worker_type: { description: @worker_type.description, guard_id: @worker_type.guard_id, name: @worker_type.name, worker_id: @worker_type.worker_id } }
    end
  ...
  test "should update worker_type" do
    patch worker_type_url(@worker_type), params: { worker_type: { description: @worker_type.description, guard_id: @worker_type.guard_id, name: @worker_type.name, worker_id: @worker_type.worker_id } }
