...
ActiveRecord::Schema.define(version: 2021_06_14_213131) do
  ...
  create_table "medical_center_types", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["medical_center_id"], name: "index_medical_center_types_on_medical_center_id"
  end
  ...
  create_table "worker_types", force: :cascade do |t|
    ...
    t.index ["worker_id"], name: "index_worker_types_on_worker_id"
  end
  ...
  add_foreign_key "medical_center_types", "medical_centers"
  add_foreign_key "worker_types", "guards"
  add_foreign_key "worker_types", "workers"
end
